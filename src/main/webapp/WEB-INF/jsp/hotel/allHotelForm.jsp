        ...
        <div class="main">
            ...
            <div class="main-content">
                ...
                <div style="text-align: center;">
                    <ul class="pagination">
                        <li class="active"><a href="${pageContext.request.contextPath}/view-all-hotel/1">1</a></li>
                        <li class=""><a href="${pageContext.request.contextPath}/view-all-hotel/2">2</a></li>
                        <li class=""><a href="${pageContext.request.contextPath}/view-all-hotel/3">3</a></li>
                    </ul>
                </div>
            </div>
        </div>
