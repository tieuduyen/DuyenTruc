        ...
        <div class="main">
            ...
            <div class="main-content">
                            ...
                            <div class="panel">
                                    ...
                                    <div class="right">
                                        <div class="dropdown" style="padding-right: 2em;">
                                            <button class="dropbtn" style="border: 1px solid black; width: 100%;">
                                                <strong>Sort Hotel Name A-Z </strong>
                                            </button>
                                ...
                                <div class="panel-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <c:forEach var="hotel" items="${hotelAscList}">
                                                <tr>
                ...
                <div style="text-align: center;">
                    <ul class="pagination">
                        <li class="active"><a href="${pageContext.request.contextPath}/sort-by-hotel-name-asc/1">1</a></li>
                        <li class=""><a href="${pageContext.request.contextPath}/sort-by-hotel-name-asc/2">2</a></li>
                        <li class=""><a href="${pageContext.request.contextPath}/sort-by-hotel-name-asc/3">3</a></li>
                    </ul>
                </div>
            </div>
            <!-- END MAIN CONTENT -->
