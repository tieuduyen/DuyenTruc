            ...
            <div class="main-content">
                <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                ...
                                <c:if test="${bookingList.size() == 0}">
                                    <h4 style="text-align: center; padding-top: 1em;">There are no Booking!</h4>
                                </c:if>
                                <c:if test="${bookingList.size() > 0}">
                    ...
                    <div style="text-align: center;">
                        <ul class="pagination">
                            <li class="active"><a href="${pageContext.request.contextPath}/view-booking-list/1">1</a></li>
                            <li class=""><a href="${pageContext.request.contextPath}/view-booking-list/2">2</a></li>
                            <li class=""><a href="${pageContext.request.contextPath}/view-booking-list/3">3</a></li>
                            <li class=""><a href="${pageContext.request.contextPath}/view-booking-list/4">4</a></li>
                            <li class=""><a href="${pageContext.request.contextPath}/view-booking-list/5">5</a></li>
                        </ul> 
                    </div>
                </div>
                <!-- END MAIN CONTENT -->
