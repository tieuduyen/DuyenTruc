        ...
        <div class="main">
            ...
            <div class="main-content">
                                    ...
                                    <div class="right">
                                        <div class="dropdown" style="padding-right: 7em;">
                                            ...
                                            <div class="dropdown-content">
                                                <a href="${pageContext.request.contextPath}/sort-by-city-name-asc/1">Sort City Name A-Z <i class="fa fa-arrow-down"></i> </a>
                                                <a href="${pageContext.request.contextPath}/sort-by-city-name-desc/1">Sort City Name Z-A <i class="fa fa-arrow-up"></i> </a>
                                            </div>
                                        </div>
                ...
                <div style="text-align: center;">
                    <ul class="pagination">
                        <li class="active"><a href="${pageContext.request.contextPath}/view-city-list/1">1</a></li>
                        <li class=""><a href="${pageContext.request.contextPath}/view-city-list/2">2</a></li>
                        <li class=""><a href="${pageContext.request.contextPath}/view-city-list/3">3</a></li>
                    </ul>
                </div>
            </div>
                        <%--
                                        ...
                                        <c:forEach var="city" items="${cityList}">
                                            <div class="col-md-6">
                                                <div class="profile-header">
                                                    <div style="height: 300px; background-image:url(<c:url value="/resources/images/${city.cityImages}" />)">
                                                        <h2 class="name" style="padding-top: 150px;">
                                                    ...
                                                    <div class="profile-stat" style="background-color: #122b40;">
                                                        <div class="row">
                                                            <div class="col-md-6 stat-item">
                                                                <a href="${pageContext.request.contextPath}/city-manager/${city.id}">
                                                                    <i class="lnr lnr-eye"></i> View
                                                                </a>
                                                            </div>
                                                            <div class="col-md-6 stat-item">
                                                                <a href="${pageContext.request.contextPath}/edit-city/${city.id}">
